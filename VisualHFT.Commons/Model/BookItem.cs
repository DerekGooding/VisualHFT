...
public partial class BookItem : IEquatable<BookItem>, IEqualityComparer<BookItem>, IResettable
{
    ...
    public string FormattedSize => Size.HasValue ? Helpers.HelperCommon.GetKiloFormatter(Size.Value) : "";
    public string FormattedActiveSize => ActiveSize.HasValue ? Helpers.HelperCommon.GetKiloFormatter(ActiveSize.Value) : "";
