...
public partial class Position
{
    ...
    private Order GetOrder(bool isOpen)
    {
        if (!string.IsNullOrEmpty(OpenClOrdId))
        {
            ...
            o.QuoteLocalTimeStamp = isOpen ? OpenQuoteLocalTimeStamp.ToDateTime() : CloseQuoteLocalTimeStamp.ToDateTime();
            o.QuoteServerTimeStamp = isOpen ? OpenQuoteServerTimeStamp.ToDateTime() : CloseQuoteServerTimeStamp.ToDateTime();
            if (isOpen)
