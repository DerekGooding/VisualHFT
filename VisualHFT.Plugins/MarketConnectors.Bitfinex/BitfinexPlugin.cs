...
public class BitfinexPlugin : BasePluginDataRetriever
{
    ...
    private Dictionary<string, OrderBook> _localOrderBooks = new Dictionary<string, OrderBook>();
    ...
    public override async Task StopAsync()
    {
        ...
        //reset models
        RaiseOnDataReceived(new DataEventArgs() { DataType = "Market", ParsedModel = new List<OrderBook>(), RawData = "" });
        RaiseOnDataReceived(new DataEventArgs() { DataType = "HeartBeats", ParsedModel = new List<Provider>() { ToHeartBeatModel(false) }, RawData = "" });
    ...
    protected override void LoadSettings()
    {
        ...
        ParseSymbols(string.Join(',', [.. _settings.Symbols])); //Utilize normalization function
    }
    ...
    protected override void InitializeDefaultSettings()
    {
        _settings = new PlugInSettings()
        {
            ...
            Symbols = ["tBTCUSD(BTC/USD)", "tETHUSD(ETH/USD)"] // Add more symbols as needed
        };
        SaveToUserSettings(_settings);
    }
