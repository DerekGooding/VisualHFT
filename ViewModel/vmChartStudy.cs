...
public class vmChartStudy : BindableBase, IDisposable
{
    ...
    private readonly List<IStudy> _studies = [];
    ...
    private readonly Dictionary<IStudy, AggregatedCollection<BaseStudyModel>> _studyToDataMap = [];
    ...
    private void _study_OnCalculated(object? sender, BaseStudyModel e)
    {
        ...
        _allDataSeries[key].Item2.ItemsSource = _allDataSeries[key].Item1.Select(x => new DataPoint(x.Date.Ticks, x.Value));
    ...
    private void InitializeData()
    {
        ...
        _selectedProvider = new Commons.WPF.ViewModel.Model.Provider(_settings.Provider);
        uiUpdaterAction();
    }
